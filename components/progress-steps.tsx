...
export const ProgressSteps: React.FC<ProgressStepsProps> = ({ currentStep }) => {
  return (
    <div className="mb-4 sm:mb-6 lg:mb-8">
      <div className="flex items-center justify-center space-x-2 sm:space-x-4 lg:space-x-6 max-w-2xl mx-auto">
        {/* Step 1 */}
        ...
        {/* Progress Line 1 */}
        <div className="flex-1 min-w-[20px] sm:min-w-[30px] lg:min-w-[40px] h-0.5 bg-gray-200 rounded-full overflow-hidden">
          <div
        ...
        <div className="flex items-center min-w-0">
          ...
          <span className={`ml-1.5 sm:ml-2 text-xs sm:text-sm lg:text-base whitespace-nowrap transition-colors duration-300 ${
            currentStep >= 3 ? "gradient-text font-medium" : "text-gray-500"
          }`}>
            方案展示
          </span>
        </div>
