...
import { WordExportEngine } from '@/engines/word-export-engine'
import { z } from 'zod'
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Received export request for Word document')
    
    // 创建Word导出引擎
    const exportEngine = new WordExportEngine()
    
    // 导出为Word文档
    const result = await exportEngine.exportToWord({
